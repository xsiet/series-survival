...
class SurvivalPlayer(survival: Survival, player: Player) {
    val uniqueId = player.uniqueId
    val name = player.name
    private val survivalRef = UpstreamReference(survival)
    val survival get() = survivalRef.get()
    private val playerRef = UpstreamReference(player)
    val player get() = playerRef.get()
    private val file get() = File(survival.playersFolder, "$uniqueId.yml")
